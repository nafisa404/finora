import { c as createLucideIcon, j as jsxRuntimeExports, d as cn, r as reactExports, g as composeRefs, R as React, h as useComposedRefs, i as reactDomExports, k as React$1, l as ReactDOM, u as useFinanceStore, P as PageContainer, e as PageHeader, f as SectionCard, B as Button, S as Skeleton, a as Badge } from "./index-B-5eHoNj.js";
import { P as Primitive$1, H as House, S as ShoppingBag } from "./index-B82x3beK.js";
import { u as useExpenses, a as useAnomalyReport, b as useAddExpense, c as useDeleteExpense, T as TriangleAlert, g as generateAlertsFromReport, Z as Zap } from "./useAnomalyReport-DCs9OQ7L.js";
import { f as format } from "./format-BGwA-lBQ.js";
import { m as motion } from "./proxy-DqR_Tkk4.js";
import { T as Trash2 } from "./trash-2-C6kXgKYa.js";
...
const Bus = createLucideIcon("bus", __iconNode$9);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function CategoryIcon({
  ...
  const iconSize = size2 === "sm" ? "h-3.5 w-3.5" : "h-4 w-4";
  const padSize = size2 === "sm" ? "p-1.5" : "p-2";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "span",
    {
      className: `inline-flex items-center justify-center rounded-lg ${padSize} ${meta.bg} flex-shrink-0`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: `${iconSize} ${meta.color}` })
    }
  );
}
const formatCurrency = (n) => new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(
  n
);
function Expenses() {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DollarSign, { className: "h-4 w-4" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      id: "amount",
