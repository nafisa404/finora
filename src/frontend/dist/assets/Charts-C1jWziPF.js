import { c as createLucideIcon, h as commonjsGlobal, i as getDefaultExportFromCjs, r as reactExports, k as clsx, R as React, l as invariant, j as jsxRuntimeExports, P as PageContainer, e as PageHeader, a as Badge, C as ChartNoAxesColumn, g as SectionCard, S as Skeleton } from "./index-CR1PEJiH.js";
import { a as useDailySpending, b as useCategoryBreakdown } from "./useDashboardStats-DqyipoVp.js";
import { f as formatCurrency } from "./currency-DMUw_CfW.js";
import { T as TrendingUp } from "./trending-up-D_6YT2Qd.js";
import "./useQuery-BTEfqfhN.js";
/**
...
function buildBarGradient(from, to) {
...
function LineTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl shadow-card px-3 py-2 text-xs", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground mb-0.5", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary font-bold text-sm", children: formatCurrency(payload[0].value) })
  ] });
}
function PieTooltip({
  active,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl shadow-card px-3 py-2 text-xs", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground mb-0.5", children: item.name }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary font-bold text-sm", children: formatCurrency(item.value) }),
...
function EmptyState({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-16 gap-3 text-muted-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-5 h-5" }) }),
...
function ChartSkeleton({ height = 260 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3 w-1/6 rounded" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-full rounded-xl", style: { height } })
  ] });
}
function Charts() {
  const { data: dailySpending = [], isLoading: dailyLoading } = useDailySpending();
  const { data: categoryBreakdown = [], isLoading: categoryLoading } = useCategoryBreakdown();
  const [activeIndex, setActiveIndex] = reactExports.useState(0);
  const grandTotal = categoryBreakdown.reduce((s2, c2) => s2 + c2.total, 0);
  const pieData = categoryBreakdown.map((c2) => ({
    ...c2,
    pct: grandTotal > 0 ? c2.total / grandTotal * 100 : 0
  }));
  const onPieEnter = reactExports.useCallback((_, index) => {
    setActiveIndex(index);
  }, []);
  const maxDay = dailySpending.length ? dailySpending.reduce((a2, b2) => a2.total > b2.total ? a2 : b2) : null;
  const weeklyTotal = dailySpending.reduce((s2, d2) => s2 + d2.total, 0);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageContainer, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 mb-6", "data-ocid": "charts.stats_row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Badge,
        {
          variant: "secondary",
      ...
      maxDay && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Badge,
        {
          variant: "outline",
          ...
          children: [
            ...
            maxDay.dayLabel,
            " (",
            formatCurrency(maxDay.total),
            ")"
          ]
        }
      ),
      pieData[0] && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Badge,
        {
          variant: "outline",
          className: "text-xs gap-1.5 px-3 py-1.5 rounded-full border-border",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold text-foreground text-base", children: "Weekly Spending" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Daily totals for the past 7 days" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-4 h-4 text-primary" }) })
            ] }),
            dailyLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChartSkeleton, { height: 260 }) : dailySpending.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              EmptyState,
              {
                icon: TrendingUp,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        SectionCard,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold text-foreground text-base", children: "Category Breakdown" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Where your money goes" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-accent/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartPie, { className: "w-4 h-4 text-accent" }) })
            ] }),
            categoryLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChartSkeleton, { height: 240 }) : pieData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { icon: ChartPie, message: "No category data yet." }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Pie,
                {
                  activeIndex,
                  ...
                  children: pieData.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Cell,
                    {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Legend,
                {
                  ...
                  formatter: (value) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.48 0.01 0)" }, children: value })
                }
              )
            ] }) })
          ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        SectionCard,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold text-foreground text-base", children: "Spending by Category" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Proportional breakdown" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "w-4 h-4 text-muted-foreground" }) })
            ] }),
            categoryLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            ] }, i)) }) : pieData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              EmptyState,
              {
              ...
              pieData.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground truncate", children: item.category })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-shrink-0 ml-2", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground text-xs tabular-nums", children: formatCurrency(item.total) })
                      ] })
                    ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-3 border-t border-border flex justify-between text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-medium", children: "Total" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-foreground tabular-nums", children: formatCurrency(grandTotal) })
              ] })
            ] })
          ]
        }
